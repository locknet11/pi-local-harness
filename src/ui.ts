...
export function configureLogging(opts: { file?: string; mirror?: boolean }): void {
  ...
  if (opts.mirror !== undefined) mirrorToStdout = opts.mirror;
}
...
function emit(line: string, plain: string): void {
...
export const log = {
  ...
  excerpt(text: string, maxLines = 20): void {
