...
export function agentsPrompt(agentsFile: string, stateDir: string): string {
...
export function specPrompt(specFile: string, featureTarget: number, stateDir: string): string {
