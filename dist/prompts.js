...
export function specRetryPrompt(specFile, errors) {
    return `
...
export function scaffoldPrompt(agentsFile, testCmdFile) {
...
export function failedVerificationSection(command, output) {
    return `
...
export function missingFileNudge(file) {
    return `
